	...
	<div class="container">
		...
		<div class="form-row info">
			<div class="form-group col-md-3">
				<a href="#">Category management</a> <font style="color: white">&nbsp;>&nbsp;<a /></font><a
					href="#">List</a>
			</div>
		</div>
		<div class="row" id="rowC">
			...
			<div class="col-md-9">
				<div class="search">
					<form class="formSearch" action="category.htm" method="post">
						<input type="text" name="cKeyWords" placeholder="Typing to search">

						<button type="submit">
							<span><img class="icon-search"
								src="<c:url value="/resources/img/search_blue.png" />"></span>
						</button>
					</form>
		...
		<div class="tableEX scroll" id="jar">
			...
			<table class="table table-borderless" id="tbCategory">
				<thead>
					<tr>
					<tr id="null">
						<th>No</th>
				...
				<tbody id="myTable">
					<c:forEach var="lists" items="${listCategoy}" varStatus="loop">
						<c:choose>
							<c:when test="${loop.index %2 ==0}">
								<tr class="content" style="background-color: #ddebf7">
									<td>${loop.index+1}</td>
									<td><a
										href="update-category.htm?categoryId=${lists.categoryId}">${lists.categoryId}</a></td>
									<td>${lists.categoryName}</td>

									<td><span> <a
											href="update-category.htm?categoryId=${lists.categoryId}"><img
...
<script type="text/javascript">
	function addNew() {
		...
		window.location.href = "add-category.htm";
...
<script type="text/javascript">
	...
	function del() {
		...
		window.location.href = "delete-category.htm?categoryId=${lists.categoryId}"
				+ id;
	}
</script>
<script
